...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Handling data locality in presence of co-processors and accelerators (\textbf{Jesus} and \textbf{Hatem})
	\end{itemize}
